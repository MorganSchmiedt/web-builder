...
- [rename-files](https://github.com/morganschmiedt/web-builder-rename-files): Change the path or the names of the files. *Useful if you would like to move the output files to a deploy directory for example.*

- [replace-constants](https://github.com/morganschmiedt/web-builder-replace-constants): Replace tags with fixed values. *Useful if you would like to replace certain values like the Hostname for example.*

- [inline-sass](https://github.com/morganschmiedt/web-builder-inline-sass): Replace tags with the content of a SASS file.

- [inline-svg](https://github.com/morganschmiedt/web-builder-inline-svg): Replace tags with the content of a SVG file.

- [inline-json](https://github.com/morganschmiedt/web-builder-inline-json): Replace tags with the content of a JSON file.

- [inline-markdown](https://github.com/morganschmiedt/web-builder-inline-markdown): Replace tags with the content of a Markdown file.

- [create-sitemap-xml](https://github.com/morganschmiedt/web-builder-create-sitemap-xml): Create a sitemap.xml file.

- [create-sitemapindex-xml](https://github.com/morganschmiedt/web-builder-create-sitemapindex-xml): Create a sitemapindex file.

- [create-robots-txt](https://github.com/morganschmiedt/web-builder-create-robots-txt): Create a robots.txt file.

- [minify-html](https://github.com/morganschmiedt/web-builder-minify-html): Minify HTML files.

- [add-hash-filename](https://github.com/morganschmiedt/web-builder-add-hash-filename): Add file hash to file name. *Useful if you would like to cache assets.*
